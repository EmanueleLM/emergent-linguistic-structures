...
def load_SST(maxlen, path=''):
    ...
    if path == '':
        path = './../data/datasets/SST_2/'
    X_train = read_csv(path + 'training/SST_2__FULL.csv', sep=',',header=None).values
    X_test = read_csv(path + 'eval/SST_2__TEST.csv', sep=',',header=None).values
    y_train, y_test = [], []
